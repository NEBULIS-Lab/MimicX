...
def unitree_g1_tracking_residual_ppo_runner_cfg() -> RslRlOnPolicyRunnerCfg:
  """Lower-noise PPO defaults for residual motion tracking bring-up."""
  cfg = unitree_g1_tracking_ppo_runner_cfg()
  cfg.actor.distribution_cfg["init_std"] = 0.35
